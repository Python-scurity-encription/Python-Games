...
if box == 'c':
    ...
    input('You cleaved them, and they are all die!')
else:
...
if box == 'o':
    ...
    input('And you find a iron sword!')
    
    input('System prompt: iron sword, increase attack damage 30, reduce attack power 10.')
